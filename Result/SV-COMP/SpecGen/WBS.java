public class WBS {
  ...
  // Internal state
  /*@ spec_public @*/ private int WBS_Node_WBS_BSCU_SystemModeSelCmd_rlt_PRE;
  /*@ spec_public @*/ private int WBS_Node_WBS_BSCU_rlt_PRE1;
  /*@ spec_public @*/ private int WBS_Node_WBS_rlt_PRE2;

  // Outputs
  /*@ spec_public @*/ public int Nor_Pressure;
  /*@ spec_public @*/ public int Alt_Pressure;
  /*@ spec_public @*/ public int Sys_Mode;

  //@ public invariant 0 <= WBS_Node_WBS_BSCU_SystemModeSelCmd_rlt_PRE && WBS_Node_WBS_BSCU_SystemModeSelCmd_rlt_PRE <= 1;
  //@ public invariant 0 <= WBS_Node_WBS_BSCU_rlt_PRE1 && WBS_Node_WBS_BSCU_rlt_PRE1 <= 4;
  //@ public invariant (WBS_Node_WBS_rlt_PRE2 == 100) || (0 <= WBS_Node_WBS_rlt_PRE2 && WBS_Node_WBS_rlt_PRE2 <= 5);
  //@ public invariant (Nor_Pressure == 0 || Nor_Pressure == 1 || Nor_Pressure == 2 || Nor_Pressure == 3 || Nor_Pressure == 5);
  //@ public invariant (Alt_Pressure == 0 || Alt_Pressure == 1 || Alt_Pressure == 2 || Alt_Pressure == 3 || Alt_Pressure == 5);
  //@ public invariant (Sys_Mode == 0 || Sys_Mode == 1);

  //@ public ensures WBS_Node_WBS_BSCU_SystemModeSelCmd_rlt_PRE == 0 && WBS_Node_WBS_BSCU_rlt_PRE1 == 0 && WBS_Node_WBS_rlt_PRE2 == 100 && Nor_Pressure == 0 && Alt_Pressure == 0 && Sys_Mode == 0;
  public WBS() {
  ...
  /*@ public ensures 0 <= Nor_Pressure && Nor_Pressure <= 5;
    @ public ensures 0 <= Alt_Pressure && Alt_Pressure <= 5;
    @ public ensures (Nor_Pressure == 0 || Nor_Pressure == 1 || Nor_Pressure == 2 || Nor_Pressure == 3 || Nor_Pressure == 5);
    @ public ensures (Alt_Pressure == 0 || Alt_Pressure == 1 || Alt_Pressure == 2 || Alt_Pressure == 3 || Alt_Pressure == 5);
    @ public ensures (Sys_Mode == 0 || Sys_Mode == 1);
    @
    @ // State updates to latches
    @ public ensures WBS_Node_WBS_rlt_PRE2 == Nor_Pressure;
    @ public ensures WBS_Node_WBS_BSCU_SystemModeSelCmd_rlt_PRE == Sys_Mode;
    @ public ensures 0 <= WBS_Node_WBS_BSCU_rlt_PRE1 && WBS_Node_WBS_BSCU_rlt_PRE1 <= 4;
    @*/
