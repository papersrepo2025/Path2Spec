...
class A2 extends A1 {
  ...
  //@ requires true;
  //@ ensures this.some_other_member == 2 && this.some_member == 1;
  A2() {
    some_other_member = 2;
  }
}
...
class A3 extends A2 {
  ...
  //@ requires true;
  //@ ensures this.yet_another_member == 3 && this.some_other_member == 2 && this.some_member == 1;
  A3() {
