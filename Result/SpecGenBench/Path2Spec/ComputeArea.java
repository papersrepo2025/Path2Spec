...
class ComputeArea {
    //@ requires (bx1 == bx2 || by1 == by2) ==> ((ax2 - ax1) * (ay2 - ay1) <= Integer.MAX_VALUE && (ax2 - ax1) * (ay2 - ay1) >= Integer.MIN_VALUE);
//@ ensures (bx1 == bx2 || by1 == by2) ==> \result == (ax2 - ax1) * (ay2 - ay1);
    public int computeOverlapArea(int ax1, int ay1, int ax2, int ay2, int bx1, int by1, int bx2, int by2) {
        ...
        int overlapWidth = (ax2 < bx2 ? ax2 : bx2) - (ax1 > bx1 ? ax1 : bx1),
            overlapHeight = (ay2 < by2 ? ay2 : by2) - (ay1 > by1 ? ay1 : by1);
