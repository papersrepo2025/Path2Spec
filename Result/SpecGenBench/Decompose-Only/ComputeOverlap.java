...
class ComputeOverlap {
    ...
    //@   requires Integer.MIN_VALUE <= ((((ax2<bx2?ax2:bx2) - (ax1>bx1?ax1:bx1))>0?((ax2<bx2?ax2:bx2) - (ax1>bx1?ax1:bx1)):0) * (((ay2<by2?ay2:by2) - (ay1>by1?ay1:by1))>0?((ay2<by2?ay2:by2) - (ay1>by1?ay1:by1)):0))
    //@                         && ((((ax2<bx2?ax2:bx2) - (ax1>bx1?ax1:bx1))>0?((ax2<bx2?ax2:bx2) - (ax1>bx1?ax1:bx1)):0) * (((ay2<by2?ay2:by2) - (ay1>by1?ay1:by1))>0?((ay2<by2?ay2:by2) - (ay1>by1?ay1:by1)):0)) <= Integer.MAX_VALUE;
    //@   assignable \nothing;
