public class StringCompare01 {
  ...
  public static void main(String[] args) {
    ...
    //@ assume s1 != null && s2 != null && s3 != null && s4 != null;
    //@ assume s1.equals("test");
    //@ assume s1 != "test";
    //@ assume s3.equalsIgnoreCase(s4);
    //@ assume s1.compareTo(s2) == 13;
    //@ assume s2.compareTo(s1) == -13;
    //@ assume s1.compareTo(s1) == 0;
    //@ assume s3.compareTo(s4) == -32;
    //@ assume s4.compareTo(s3) == 32;
    //@ assume !s3.regionMatches(0, s4, 0, 5);
    //@ assume s3.regionMatches(true, 0, s4, 0, 5);
